<template>
  <div class="panel-wrap" v-if=" tab === 1">
    ...
    <div class="panel-row">
      ...
      <div class="panel-label">Largeur</div>
    ...
    <div class="panel-row">
      ...
      <div class="panel-label">Hauteur</div>
    ...
    <div class="panel-row">
      ...
      <div class="panel-label">Abscisse</div>
    ...
    <div class="panel-row">
      ...
      <div class="panel-label">Y-axis</div>
    ...
    <div v-if="activeElement.isChild">
      ...
      <div class="panel-row">
        <icon name="layout" />
        <div class="panel-label">Conteneur</div>
