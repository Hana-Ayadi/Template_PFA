        ...
        <div id="container">
            ...
            <div id="main">
                ...
                <div id="receiveMessageArea">
                    Received Messages:
                    <div id="conversation" :style="{top:top, width:width , height:height,left: left}"></div>
                </div>
            </div>
    ...
    export default {
        ...
        methods: {
            ...
            convertListToButtons (roomName, occupants, isPrimary) {
                ...
                var otherClientDiv = document.getElementById('otherClients')
               // var sendMessage = document.getElementByClass('sendMessage')

                var self = this;
                this.listUser = occupants;
                for (var easyrtcid in occupants) {
                    var button = document.createElement('button')
